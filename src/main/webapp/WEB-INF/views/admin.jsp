        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="/admin"><i class="fa fa-dashboard fa-fw"></i> Panel</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Wykresy<span class="fa arrow"></span></a>
                    ...
                    <li>
                        <a href="tables.html"><i class="fa fa-table fa-fw"></i> Tabele</a>
                    </li>
                    <li>
                        <a href="forms.html"><i class="fa fa-edit fa-fw"></i> Formularze</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-wrench fa-fw"></i> UI<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
